...
router.get("/category", productsController.categoryIndex); //filtro por marca
router.get("/category/:id", productsController.category); //filtro por marca
...
); // direccion de creacion(donde apunta el formulario)
...
); //accion de edicion (donde apunta el formulario)
