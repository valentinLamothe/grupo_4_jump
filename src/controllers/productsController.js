...
const productsController = {
	generateId: function (id) {
		let products = obtenerProductos(); //llamada a la función que trae el objeto literal de los productos
	...
	update: (req, res) => {
		...
		nueva.sort(function (a, b) {
			return a.id - b.id;
		}); //ordena array de objetos, necesario para futuro no romper el generateID
